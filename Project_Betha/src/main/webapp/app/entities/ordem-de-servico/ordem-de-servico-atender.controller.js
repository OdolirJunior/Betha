(function() {
    ...
    angular
        ...
        .controller('OrdemDeServicoAtenderController', OrdemDeServicoAtenderController);

    OrdemDeServicoAtenderController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'OrdemDeServico', 'Cliente'];


    function OrdemDeServicoAtenderController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, OrdemDeServico, Cliente) {
        var vm = this;
