(function() {
    ...
    OrdemDeServicoFecharOrdemController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'OrdemDeServico', 'Cliente'];

    function OrdemDeServicoFecharOrdemController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, OrdemDeServico, Cliente) {
        var vm = this;
